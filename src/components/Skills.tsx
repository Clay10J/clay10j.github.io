...
export default function Skills() {
  return (
    <div className="container mx-auto my-10">
      <h1 className="m-4 text-xl md:text-5xl">Skills</h1>
      <div className="grid grid-cols-2 justify-items-center md:grid-cols-4">
        <DiPython
          className="w-16 h-16 m-1 md:h-36 md:w-36 md:justify-self-end"
          title="python"
        />
        ...
        />
        <SiPowershell
          className="w-16 h-16 m-1 md:h-36 md:w-36 md:justify-self-start"
          title="powershell"
        />
      </div>
    </div>
